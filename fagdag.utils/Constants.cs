...
public static class Constants
{
    ...
    public const string AzureCognitiveServicesApiKey = "AZURE_COGNITIVESERVICES_API_KEY";
    public const string AzureCognitiveServicesEndpoint = "AZURE_COGNITIVESERVICES_ENDPOINT";
